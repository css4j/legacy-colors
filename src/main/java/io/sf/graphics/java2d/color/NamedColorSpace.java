...
public class NamedColorSpace extends ColorSpace implements ColorSpaceOrigin {
	 ...
	 * 
	 * @param name        the color name
	 * @param xyz         the CIE XYZ coordinates (valid values: 0.0f to 1.0f,
	 *                    although values slightly larger than 1.0f are common)
	 ...
	 * 
	 * @param name        the color name
	 * @param color       the color to use when the named color's specific color
	...
	/**
	 * Returns an sRGB-based color representing the full-tint color defined by this
	 * named color space.
	 * 
