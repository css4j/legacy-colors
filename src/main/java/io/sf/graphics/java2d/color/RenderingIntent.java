...
public enum RenderingIntent {
	...
	/**
	 * Returns an integer value identifying the rendering intent. This is the same
	 * value defined by the ICC specification (0..3) plus one for "auto" (4). (See
	 * also {@link ICC_Profile}.ic*)
	 * 
	...
	/**
	 * Returns the enum value for the given integer rendering intent (as defined by
	...
	public static RenderingIntent fromICCValue(int value) {
		switch (value) {
		case ICC_Profile.icPerceptual:
			return PERCEPTUAL;
		case ICC_Profile.icRelativeColorimetric:
			return RELATIVE_COLORIMETRIC;
		case ICC_Profile.icAbsoluteColorimetric:
			return ABSOLUTE_COLORIMETRIC;
		case ICC_Profile.icSaturation:
			return SATURATION;
		default:
