...
public final class ColorProfileUtil {
	 ...
	 * synchronizes the call to avoid a potential race condition.
	 * 
	 * @param colorSpace the type of color space to create a profile for. The
	 *                   specified type is one of the color space constants defined
	 *                   in the {@link ColorSpace} class.
	 * @return an {@link ICC_Profile} instance corresponding to the specified
	 *         {@code ColorSpace}
	 * @throws IllegalArgumentException if {@code colorSpace} is not one of the
	 *                                  predefined types
	 */
	...
	/**
	 * Proxy method for {@link ICC_Profile#getInstance(java.io.InputStream)} that
