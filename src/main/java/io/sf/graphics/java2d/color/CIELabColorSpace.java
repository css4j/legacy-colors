...
public class CIELabColorSpace extends ColorSpace {
	 ...
	 * 
	 * @param whitePoint the white point in XYZ coordinates (valid values: 0.0f to
	...
	/**
	 * Transforms a color value assumed to be in this {@link ColorSpace} into the
	 * CS_CIEXYZ conversion color space. This method uses component values in CIE
	 * Lab's native color ranges rather than the normalized values between 0 and 1.
	 * 
	...
	/**
	 * Creates a {@link Color} instance from color values usually used by the L*a*b*
	 * color space by scaling them to the 0.0..1.0 range expected by Color's
	 * constructor.
	 * 
	 * @param colorvalue the original color values (native value range, i.e. not
