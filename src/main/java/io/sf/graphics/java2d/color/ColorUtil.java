...
public final class ColorUtil {
	...
	/**
	 * Checks if two colors are the same color. This check is much more restrictive
	 * than {@link Color#equals(Object)} in that it doesn't only check if both
	 * colors result in the same sRGB value. For example, if two colors not of the
	 * same exact class are compared, they are treated as not the same.
	 * <p>
