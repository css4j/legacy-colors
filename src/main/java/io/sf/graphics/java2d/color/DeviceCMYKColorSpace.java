...
public class DeviceCMYKColorSpace extends AbstractDeviceSpecificColorSpace implements ColorSpaceOrigin {
	...
	public float[] toRGB(float[] colorvalue) {
		return new float[] { (1 - colorvalue[0]) * (1 - colorvalue[3]), (1 - colorvalue[1]) * (1 - colorvalue[3]),
	...
	/**
	 * Creates a color instance representing a device-specific CMYK color. An sRGB
	 * value is calculated from the CMYK colors but it may not correctly represent
	 * the given CMYK values.
	 * 
